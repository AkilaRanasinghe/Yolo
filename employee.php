        ...
        <div class="row">
          <div class="column side">
            <section class="sideMenu">
              <nav class="side">
                <a href="help.php">Employee Details</a>
...
<?php
    ...
    if($result->num_rows > 0)
    {
      while ($row = $result->fetch_assoc()) 
      {
        ...
        //echo "<td><button type = 'submit'><a href = 'editemp.php?ID= $id'>edit</a> </button></td>";
        //echo "<td><button type = 'submit'><a href = 'deletemp.php?ID= $id'>delete</a> </button></td>";
      }
    }
    else 
    {
