...
if($uname == "")
{
	echo "<a href='#' style='color: #51cbf0'>SIGN IN</a>";
}
else
{
...
<center>
	<div id="loginpic">
		<img src="images/user2.png"  width="100px" height="110px" >
	</div>
</center>
<div class="row">
<div class="coln" style="background-color:rgb(163, 237, 239);color:white;">
...
<label for="log"><b>Login as User.</b></label>
<br><br>
