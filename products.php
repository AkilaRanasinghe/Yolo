...
?>
<div class="ite">
<button id="crd"><a href="tops.php"><div class="crd">
  <img src="images/topmore.jpg" alt="topmore" class="moreimge">
</div></a></button>
</div>
</div>
...
$sql = "SELECT * FROM item where item.Category = 'Trousers' limit 3";
$result = $conn->query($sql);
...
?>
<div class="ite">
<button id="crd"><a href="#"><div class="crd">
  <img src="images/trousermore.jpg" alt="trousermore" class="moreimge">
</div></a></button>
</div>
</div>
<h2 id="shirts">T-SHIRTS</h2>
<div class="row">
<?php
$servername = "localhost"; 
$username = "root"; 
...
$sql = "SELECT * FROM item where item.Category = 'T-Shirts' limit 3";
$result = $conn->query($sql);
...
<div class="ite">
<button id="crd"><a href="#"><div class="crd">
  <img src="images/shirtmore.jpg" alt="shirtmore" class="moreimge">
</div></a></button>
</div>
</div>
<h2 id="frocks">FROCKS</h2>
<div class="row">
<?php
$servername = "localhost"; 
$username = "root"; 
...
$sql = "SELECT * FROM item where item.Category = 'Frocks' limit 3";
$result = $conn->query($sql);
...
<div class="ite">
<button id="crd"><a href="#"><div class="crd">
  <img src="images/frockmore.jpg" alt="frockmore" class="moreimge">
</div></a></button>
</div>
</div>
<h1 id="foot">FOOTWARE</h1>
<h2 id="sandles">SANDLES</h2>
<div class="row">
<?php
$servername = "localhost"; 
$username = "root"; 
...
$sql = "SELECT * FROM item where item.Category = 'Sandles' limit 3";
$result = $conn->query($sql);
...
<div class="ite">
<button id="crd"><a href="#"><div class="crd">
  <img src="images/sandlemore.jpg" alt="sandlemore" class="moreimge">
</div></a></button>
</div>
</div>
<h2 id="flats">FLATS</h2>
<div class="row">
<?php
$servername = "localhost"; 
$username = "root"; 
...
$sql = "SELECT * FROM item where item.Category = 'Flats' limit 3";
$result = $conn->query($sql);
...
<div class="ite">
<button id="crd"><a href="#"><div class="crd">
  <img src="images/flatmore.jpg" alt="flatmore" class="moreimge">
</div></a></button>
</div>
</div>
<h2 id="heels">HEELS</h2>
<div class="row">
<?php
$servername = "localhost"; 
$username = "root"; 
...
$sql = "SELECT * FROM item where item.Category = 'Heels' limit 3";
$result = $conn->query($sql);
...
<div class="ite">
<button id="crd"><a href="#"><div class="crd">
  <img src="images/heelmore.jpg" alt="heelmore" class="moreimge">
</div></a></button>
</div>
</div>
<h1 id="bags">BAGS</h1>
<h2 id="back">BACKPACKS</h2>
<div class="row">
<?php
$servername = "localhost"; 
$username = "root"; 
...
$sql = "SELECT * FROM item where item.Category = 'Backpacks' limit 3";
$result = $conn->query($sql);
...
<div class="ite">
<button id="crd"><a href="#"><div class="crd">
  <img src="images/backmore.jpg" alt="backmore" class="moreimge">
</div></a></button>
</div>
</div>
<h2 id="clutches">CLUTCHES</h2>
<div class="row">
<?php
$servername = "localhost"; 
$username = "root"; 
...
$sql = "SELECT * FROM item where item.Category = 'Clutches' limit 3";
$result = $conn->query($sql);
...
<div class="ite">
<button id="crd"><a href="#"><div class="crd">
  <img src="images/clutchmore.jpg" alt="clutchmore" class="moreimge">
</div></a></button>
</div>
</div>
<h2 id="shoulder">SHOULDER BAGS</h2>
<div class="row">
<?php
$servername = "localhost"; 
$username = "root"; 
...
$sql = "SELECT * FROM item where item.Category = 'Shoulder' limit 3";
$result = $conn->query($sql);
...
<div class="ite">
<button id="crd"><a href="#"><div class="crd">
  <img src="images/shouldermore.jpg" alt="shouldermore" class="moreimge">
</div></a></button>
</div>
</div>
<h1 id="acce">ACCESSORIES</h1>
<h2 id="jewelleries">JEWELLERIES</h2>
<div class="row">
<?php
$servername = "localhost"; 
$username = "root"; 
...
$sql = "SELECT * FROM item where item.Category = 'Jewelleries' limit 3";
$result = $conn->query($sql);
...
<div class="ite">
<button id="crd"><a href="#"><div class="crd">
  <img src="images/accmore.jpg" alt="accmore" class="moreimge">
</div></a></button>
</div>
</div>
...
$sql = "SELECT * FROM item where item.Category = 'Sunglasses' limit 3";
$result = $conn->query($sql);
...
<div class="ite">
<button id="crd"><a href="#"><div class="crd">
  <img src="images/sunglassmore.jpg" alt="sunglassmore" class="moreimge">
</div></a></button>
</div>
</div>
</center>
